...
messages = [{"role": "assistant",
             "content": "Expert sur la documentation de l'équipe DataPlatform, à votre service..."}]
...
with gr.Blocks(css=css_styles, title= "Chatbot Socle DP") as demo:
    logger.info("Starting Demo...")

    with gr.Row():
        header = gr.Markdown(
            value="""<center><img src="file/public/img/title.svg" class="logo_title"/></center>""", elem_id="header")
    ...
    with gr.Row(elem_id="input_container"):
        txt = gr.Textbox(show_label=False, max_lines=2, placeholder="Quels sont les sujets en cours par la Data Platform ?",
